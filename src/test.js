...
console.log('processValue1: ' + processValue1);
console.log('processValue2: ' + processValue2);
console.log('processValue3: ' + processValue3);
//write single buffer
...
console.log('writtenProcessValue3: ' + writtenProcessValue3);
